...
@function_tool
async def analyze_code_syntax(ctx: RunContextWrapper[Any], code: str, language: str) -> Dict[str, Any]:
    """
...
@function_tool
async def get_language_best_practices(ctx: RunContextWrapper[Any], language: str) -> List[str]:
    """
    ...
    return best_practices.get(language.lower(), ["No specific best practices available for this language"])
