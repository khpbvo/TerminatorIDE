...
"""
from typing import Optional, List, Dict, Any, Union, Callable, Type, TypeVar
from pydantic import BaseModel, create_model
import inspect
import logging
from agents import (
    handoff, Agent, RunContextWrapper, HandoffOutput,
    Handoff, InputFilter
)
...
class HandoffManager:
    ...
    def create_escalation_handoff(
        ...
        async def on_escalation(ctx: RunContextWrapper[Any], input_data: EscalationData):
