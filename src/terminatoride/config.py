...
class Config:
    ...
    def from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            app=AppConfig(
                ...
                show_line_numbers=os.environ.get("TERMINATOR_SHOW_LINE_NUMBERS", "True").lower() == "true",
                auto_save=os.environ.get("TERMINATOR_AUTO_SAVE", "True").lower() == "true",
            )
        )
    ...
    def load_from_file(cls, config_path: Path) -> 'Config':
        ...
        return cls(
            openai=OpenAIConfig(
                api_key=openai_data.get("api_key", os.environ.get("OPENAI_API_KEY", "")),
